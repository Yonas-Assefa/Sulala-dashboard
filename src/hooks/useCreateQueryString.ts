  ...
  const createQueryString = React.useCallback(
    (nameOrParams: string | KeyValue[], value?: string) => {
      ...
      if (Array.isArray(nameOrParams)) {
        ...
        throw new Error(
          "Invalid arguments. Either provide a key-value pair or an array of objects with key-value pairs.",
        );
      }
  ...
  const deleteQueryString = React.useCallback(
    (nameOrParams: string | string[]) => {
      ...
      if (Array.isArray(nameOrParams)) {
        ...
        throw new Error(
          "Invalid arguments. Either provide a key or an array of keys.",
        );
      }
