...
function SideBarOptions() {
    ...
    return (
        <div className="dropdown dropdown-hover dropdown-bottom md:dropdown-top dropdown-end md:block hidden">
            <div tabIndex={0} role="button" className="p-2">
                <img src="/icons/more-horizontal.svg" alt="" />
            </div>
            <div tabIndex={0} className="dropdown-content z-[1] bg-white menu p-2 shadow rounded-box">
