...
function loading() {
    return (<div className='text-black pt-12 flex flex-col w-full h-full justify-center p-8 gap-3 overflow-y-scroll'>

        <div className='flex justify-center gap-3'>
            <div className="w-[100px] h-8 bg-gray-200 rounded animate-pulse"></div>
        </div>

        <ul className="mt-5 grid grid-cols-2 gap-4 animate-pulse">
        ...
        <ul className="mt-5 space-y-3 animate-pulse">
            <li className="w-full h-12 bg-gray-200 rounded-full "></li>
            <li className="w-full h-12 bg-gray-200 rounded-full "></li>
        </ul>
