...
export const metadata: Metadata = {
  ...
  description:
    "Setup your Sulala account to start buying and selling goods and services.",
...
async function SetupAccount({ searchParams: { stage: activeStage } }: Props) {
  ...
  return (
    <div className="w-10/12 flex flex-col gap-5 items-center">
      ...
      {/* SIGN IN HEADER */}
      <h1 className="text-3xl text-center md:text-[40px] md:py-2 font-serif font-semibold">
        {t("setup_your_account")}
      </h1>
