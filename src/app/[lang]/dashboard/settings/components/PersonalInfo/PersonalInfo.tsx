      ...
      <div className="grid grid-cols-1 md:grid-cols-2 max-w-[1300px] gap-5">
        ...
        <div className="flex flex-col gap-0 w-full items-center">
          <PhoneNumberInput
            ...
            error={formState?.fieldErrors?.phone_number?.[0]}
        ...
        <div className="w-full flex flex-col relative">
          ...
          <div className="flex self-end flex-row gap-1 absolute -bottom-5 ">
            ...
            />
            <p
              className={`text-[13px] font-semibold italic ${data.email_verified == false ? "text-danger" : "text-primary"}`}
            >
              {data.email_verified == false
        ...
        <TextInput
          ...
          label={t("address")}
          error={formState?.fieldErrors?.address?.[0]}
        />
      </div>
      ...
      <div className="flex flex-col items-start py-4 gap-8">
        ...
        <div className="flex flex-col gap-3">
          <SecondaryButton
            ...
            modal="change_password_setting_modal"
            type="button"
          />
          <SecondaryButton
            padding={"xsm"}
            name={t("log_out")}
            modal="logout_setting_modal"
            type="button"
          />
        </div>
      </div>
