            ...
            <div className='bg-white flex-grow'>
                <div className='w-full h-full flex justify-between flex-col items-center'>
                    <div className='flex flex-col justify-center items-center w-full h-full'>
                        ...
                        <h1 className='text-2xl md:text-4xl text-center  font-semibold text-danger'>Error - While loading settings</h1>
                        ...
                        <img src='/icons/settings.svg' className='w-[100px] opacity-15 absolute' />
                    </div>
                </div>
            </div>
        </div>
