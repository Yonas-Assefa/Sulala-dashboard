...
function SideBarNav({ isSuperUser }: Props) {
  ...
  return (
    <nav
      ref={ref}
      className="md:min-w-[300px] z-50 drop-shadow-lg md:h-full bg-tertiary dark:bg-black fixed md:relative md:w-auto w-full h-auto md:flex flex-col justify-between"
    >
      <div className="group">
