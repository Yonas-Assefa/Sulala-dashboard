...
function ProductHead() {
    ...
    return (
        <div className='flex flex-col md:flex-row justify-between'>
            <h1 className='text-2xl md:text-4xl font-semibold font-serif'>{t('my_products')}</h1>
