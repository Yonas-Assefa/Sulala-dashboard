...
function TextInput({
  ...
  return (
    <label htmlFor={id} className="flex flex-col gap-3">
      ...
      <div
        className={`flex items-center px-3 justify-between gap-0 border rounded-[40px] w-full ${error ? "bg-dangerlight border-danger" : "bg-white focus-within:border-primary"}`}
      >
        <input
          id={id}
          type={type}
